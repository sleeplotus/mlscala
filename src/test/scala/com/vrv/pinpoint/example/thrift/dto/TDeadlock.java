...
public class TDeadlock implements org.apache.thrift.TBase<TDeadlock, TDeadlock._Fields>, java.io.Serializable, Cloneable, Comparable<TDeadlock> {
  ...
  private java.util.List<TThreadDump> deadlockedThreadList; // optional
  ...
  public TDeadlock(TDeadlock other) {
    ...
    if (other.isSetDeadlockedThreadList()) {
      java.util.List<TThreadDump> __this__deadlockedThreadList = new java.util.ArrayList<TThreadDump>(other.deadlockedThreadList.size());
      for (TThreadDump other_element : other.deadlockedThreadList) {
        __this__deadlockedThreadList.add(new TThreadDump(other_element));
      }
  ...
  public java.util.Iterator<TThreadDump> getDeadlockedThreadListIterator() {
    return (this.deadlockedThreadList == null) ? null : this.deadlockedThreadList.iterator();
  }

  public void addToDeadlockedThreadList(TThreadDump elem) {
    if (this.deadlockedThreadList == null) {
      this.deadlockedThreadList = new java.util.ArrayList<TThreadDump>();
    }
    this.deadlockedThreadList.add(elem);
  }

  public java.util.List<TThreadDump> getDeadlockedThreadList() {
    return this.deadlockedThreadList;
  }

  public void setDeadlockedThreadList(java.util.List<TThreadDump> deadlockedThreadList) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DEADLOCKED_THREAD_COUNT:
      if (value == null) {
        ...
        setDeadlockedThreadCount((Integer)value);
      }
      break;
    ...
    case DEADLOCKED_THREAD_LIST:
      if (value == null) {
        ...
        setDeadlockedThreadList((java.util.List<TThreadDump>)value);
      }
      break;
  ...
  public int compareTo(TDeadlock other) {
    ...
    lastComparison = Boolean.valueOf(isSetDeadlockedThreadCount()).compareTo(other.isSetDeadlockedThreadCount());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetDeadlockedThreadList()).compareTo(other.isSetDeadlockedThreadList());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDeadlockedThreadList()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TDeadlock(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.deadlockedThreadList = new java.util.ArrayList<TThreadDump>(_list32.size);
                TThreadDump _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = new TThreadDump();
                  _elem33.read(iprot);
      ...
      if (struct.deadlockedThreadList != null) {
        if (struct.isSetDeadlockedThreadList()) {
          oprot.writeFieldBegin(DEADLOCKED_THREAD_LIST_FIELD_DESC);
          {
            ...
            for (TThreadDump _iter35 : struct.deadlockedThreadList)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetDeadlockedThreadList()) {
        {
          ...
          for (TThreadDump _iter36 : struct.deadlockedThreadList)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.deadlockedThreadList = new java.util.ArrayList<TThreadDump>(_list37.size);
          TThreadDump _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new TThreadDump();
            _elem38.read(iprot);
