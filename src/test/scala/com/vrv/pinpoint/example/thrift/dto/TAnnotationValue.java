...
public class TAnnotationValue extends org.apache.thrift.TUnion<TAnnotationValue, TAnnotationValue._Fields> {
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case LONG_INT_INT_BYTE_BYTE_STRING_VALUE:
        ...
        throw new ClassCastException("Was expecting value of type TLongIntIntByteByteStringValue for field 'longIntIntByteByteStringValue', but got " + value.getClass().getSimpleName());
      case INT_BOOLEAN_INT_BOOLEAN_VALUE:
        if (value instanceof TIntBooleanIntBooleanValue) {
          break;
        }
        throw new ClassCastException("Was expecting value of type TIntBooleanIntBooleanValue for field 'intBooleanIntBooleanValue', but got " + value.getClass().getSimpleName());
      default:
  ...
  public TLongIntIntByteByteStringValue getLongIntIntByteByteStringValue() {
    if (getSetField() == _Fields.LONG_INT_INT_BYTE_BYTE_STRING_VALUE) {
      ...
      throw new RuntimeException("Cannot get field 'longIntIntByteByteStringValue' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TIntBooleanIntBooleanValue getIntBooleanIntBooleanValue() {
    if (getSetField() == _Fields.INT_BOOLEAN_INT_BOOLEAN_VALUE) {
      ...
      throw new RuntimeException("Cannot get field 'intBooleanIntBooleanValue' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
