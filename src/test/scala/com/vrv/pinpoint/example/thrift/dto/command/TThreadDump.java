 ...
 *  @generated
 */
package com.vrv.pinpoint.example.thrift.dto.command;
...
public class TThreadDump implements org.apache.thrift.TBase<TThreadDump, TThreadDump._Fields>, java.io.Serializable, Cloneable, Comparable<TThreadDump> {
  ...
  private java.util.List<String> stackTrace; // required
  private java.util.List<TMonitorInfo> lockedMonitors; // required
  private java.util.List<String> lockedSynchronizers; // required
  ...
  public TThreadDump(
    ...
    java.util.List<String> lockedSynchronizers)
  {
    this();
  ...
  public TThreadDump(TThreadDump other) {
    ...
    if (other.isSetStackTrace()) {
      java.util.List<String> __this__stackTrace = new java.util.ArrayList<String>(other.stackTrace);
    ...
    if (other.isSetLockedSynchronizers()) {
      java.util.List<String> __this__lockedSynchronizers = new java.util.ArrayList<String>(other.lockedSynchronizers);
  ...
  public void addToStackTrace(String elem) {
    if (this.stackTrace == null) {
      this.stackTrace = new java.util.ArrayList<String>();
    }
  ...
  public void setStackTrace(java.util.List<String> stackTrace) {
    this.stackTrace = stackTrace;
  }
  ...
  public void addToLockedSynchronizers(String elem) {
    if (this.lockedSynchronizers == null) {
      this.lockedSynchronizers = new java.util.ArrayList<String>();
    }
    this.lockedSynchronizers.add(elem);
  }

  public java.util.List<String> getLockedSynchronizers() {
    return this.lockedSynchronizers;
  }

  public void setLockedSynchronizers(java.util.List<String> lockedSynchronizers) {
    this.lockedSynchronizers = lockedSynchronizers;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case STACK_TRACE:
      if (value == null) {
        ...
        setStackTrace((java.util.List<String>)value);
      }
      break;
    ...
    case LOCKED_SYNCHRONIZERS:
      if (value == null) {
        ...
        setLockedSynchronizers((java.util.List<String>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stackTrace = new java.util.ArrayList<String>(_list0.size);
                String _elem1;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lockedSynchronizers = new java.util.ArrayList<String>(_list6.size);
                String _elem7;
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.stackTrace = new java.util.ArrayList<String>(_list15.size);
          String _elem16;
      ...
      if (incoming.get(14)) {
        {
          ...
          struct.lockedSynchronizers = new java.util.ArrayList<String>(_list21.size);
          String _elem22;
